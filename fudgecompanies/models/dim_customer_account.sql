...
WITH full_cte AS (
    SELECT 
        ...
        CONCAT( m.account_firstname, ' ', m.account_lastname) as customer_account_full_name,
...
only_FM_CTE AS (
    SELECT 
        ...
        CONCAT(c.customer_firstname, ' ', c.customer_lastname) as customer_account_full_name,
